...
/* LCD Pin Definitions */
#define LCD_GPIO_SCLK      (GPIO_NUM_4) // SPI clock pin
#define LCD_GPIO_MOSI      (GPIO_NUM_9) // SPI data output pin (ST7789 simplex, MISO not required)
#define LCD_GPIO_RST       (GPIO_NUM_NC) // Reset pin
#define LCD_GPIO_DC        (GPIO_NUM_7) // Command/data distinction pin
#define LCD_GPIO_CS        (GPIO_NUM_3) // Chip select pin
#define LCD_GPIO_BL        (GPIO_NUM_5) // Backlight pin
